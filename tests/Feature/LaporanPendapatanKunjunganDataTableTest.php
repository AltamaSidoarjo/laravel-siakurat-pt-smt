...
class LaporanPendapatanKunjunganDataTableTest extends TestCase
{
    ...
    public function test_grand_total_is_returned_for_filtered_kunjungan_rows(): void
    {
    ...
    public function test_grand_total_uses_intersection_of_filters_and_global_search(): void
    {
        $this->seedImportedPendapatanRows();
