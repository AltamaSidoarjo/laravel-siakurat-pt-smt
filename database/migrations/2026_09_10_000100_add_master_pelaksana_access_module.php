...
{
    private const MODULE_CODE = 'pengaturan.master-pelaksana';
    ...
    public function up(): void
    {
        ...
        DB::table('access_modules')->updateOrInsert(
            ...
            ['nama' => 'Master Pelaksana', 'group_nama' => 'Pengaturan', 'urutan' => 220, 'created_at' => $timestamp, 'updated_at' => $timestamp],
        );
        ...
        $existingRoleIds = DB::table('role_permissions')->where('access_module_id', $moduleId)->pluck('role_id')->all();
        $permissions = DB::table('roles')->select('id', 'is_system')->get()
