...
@section('content')
                                ...
                                <form method="get" action="">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4 d-flex align-items-end justify-content-end gap-2 flex-wrap">
                                            <a href="{{ route('pembelian.pembayaran.index') }}" class="btn btn-light">Reset</a>
    ...
    @include('partials.export-csv-modal', ['exportRoute' => route('pembelian.pembayaran.export-csv'), 'exportTitle' => 'Pembayaran Pembelian', 'startDate' => $startDate, 'endDate' => $endDate])
@endsection
