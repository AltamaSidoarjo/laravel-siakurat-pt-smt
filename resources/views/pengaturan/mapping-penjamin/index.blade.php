...
@section('title', 'Mapping Penjamin')
    ...
    <div class="row mb-3">
        <div class="col">
            <div class="d-flex align-items-center gap-3 fs-3">
                ...
                <span class="fw-bold">Mapping Penjamin</span>
            </div>
        </div>
    </div>
            ...
            <div class="card border-muhammadiyah mb-2">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column gap-3">
                        @if (auth()->user()?->hasModuleAccess('pengaturan.mapping-penjamin', 'create'))
                        <div class="card border-light shadow-sm">
                            <div class="card-body">
                                <div class="d-flex justify-content-end gap-3 align-items-center">
                                    <a href="{{ route('pengaturan.mapping-penjamin.create') }}" class="btn btn-success fw-bold">
