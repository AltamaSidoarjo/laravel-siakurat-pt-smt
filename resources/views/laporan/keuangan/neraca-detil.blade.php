    ...
    <div class="row mb-3">
        <div class="col">
            <div class="d-flex align-items-center gap-3 fs-3">
                ...
                <span class="fw-bold">Neraca Detil</span>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="laporan-header text-center mb-4">
                        ...
                        <div class="laporan-header__identity">
                            ...
                            <div class="fw-bold laporan-header__title-report">Neraca Detil</div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm table-bordered table-hover" id="neraca-detil-table">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center text-muted py-4">Tidak ada data neraca detil.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
