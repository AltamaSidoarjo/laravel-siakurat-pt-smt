...
@section('title', 'Buku Pembantu Hutang (Mutasi)')
    ...
    <div class="row mb-3">
        <div class="col">
            <div class="d-flex align-items-center gap-3 fs-3">
                ...
                <span class="fw-bold">Buku Pembantu Hutang (Mutasi)</span>
            </div>
        </div>
    </div>
    ...
    <div class="card border-muhammadiyah mb-2">
        <div class="card-body d-flex flex-column gap-3">
            ...
            <div class="card border-light shadow-sm">
                <div class="card-body">
                    <form method="get" action="{{ route('laporan.pembelian.buku-pembantu-hutang-mutasi') }}" id="filterForm">
                        <div class="row g-3">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-6 d-flex align-items-end justify-content-end gap-2 flex-wrap">
                                <a href="{{ route('laporan.pembelian.buku-pembantu-hutang-mutasi') }}" class="btn btn-light">Reset</a>
                                <button type="submit" class="btn btn-primary"><i class="bi bi-funnel me-1"></i>Tampilkan</button>
                                <button type="submit" class="btn btn-outline-success" formaction="{{ route('laporan.pembelian.buku-pembantu-hutang-mutasi.export-csv') }}" @disabled(! $hasSelection)>
