...
@section('title', 'Rangkuman Buku Pembantu Piutang')
    ...
    <div class="row mb-3 no-print">
        <div class="col">
            <div class="d-flex align-items-center gap-3 fs-3">
                ...
                <span class="fw-bold">Rangkuman Buku Pembantu Piutang</span>
            </div>
        </div>
    </div>
    ...
    <div class="card border-muhammadiyah mb-2 report-shell">
        <div class="card-body d-flex flex-column gap-3">
            ...
            @include('laporan.pendapatan._piutang-filter', [
                'formAction' => route('laporan.pendapatan.rangkuman-buku-pembantu-piutang'),
                'resetAction' => route('laporan.pendapatan.rangkuman-buku-pembantu-piutang'),
                'exportAction' => route('laporan.pendapatan.rangkuman-buku-pembantu-piutang.export-csv'),
            ])
            ...
            <div class="summary-report">
                <header class="report-header text-center mb-4">
                    ...
                    <h1>RANGKUMAN BUKU PEMBANTU PIUTANG</h1>
                ...
                @if ($rows !== [])
                    <div class="table-responsive report-table-wrapper">
                        <table class="table table-sm mb-0 summary-table">
                            ...
                            <tbody>
                                @foreach ($rows as $row)
                                    <tr>
                                        <td>{{ strtoupper($row['nama_pelanggan']) }} | {{ $row['kode_pelanggan'] ?: '-' }}</td>
                    ...
                    <div class="text-end fw-bold mt-2 report-balance">
                        Total Piutang: {{ number_format($summary['saldo_piutang'], 2, ',', '.') }}
                    </div>
                @else
