@php
    ...
    $nominalTotal = (int) round((float) $kasbankPenerimaan->total);
...
<head>
    ...
    <title>BM : {{ $kasbankPenerimaan->nomer }}</title>
...
<body>
    ...
    <div class="wrapper">
        ...
        <table class="table-print">
            ...
            <tbody>
                <tr>
                    <td class="wrap-text"><b>Bukti Masuk:</b> {{ $kasbankPenerimaan->coa?->kode }} - {{ $kasbankPenerimaan->coa?->nama }}</td>
                    <td class="wrap-text"><b>Nomer:</b> {{ $kasbankPenerimaan->nomer }}</td>
                    <td class="wrap-text"><b>Tanggal:</b> {{ optional($kasbankPenerimaan->tanggal)->format('d/m/Y') }}</td>
                </tr>
            </tbody>
        </table>
        ...
        <table class="table-print mt-2">
            ...
            <tbody>
                @forelse ($kasbankPenerimaan->rincian as $item)
                    <tr>
            ...
            <tfoot>
                <tr>
                    ...
                    <td class="num" style="font-weight:700;">{{ $formatRupiah($kasbankPenerimaan->total) }}</td>
                </tr>
            </tfoot>
        </table>
