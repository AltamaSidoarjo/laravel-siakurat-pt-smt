...
@section('title', 'Kasbank Pembayaran')
...
@section('content')
    <div class="row mb-3">
        <div class="col">
            <div class="d-flex align-items-center gap-3 fs-3">
                ...
                <span class="fw-bold">Kasbank Pembayaran</span>
            </div>
        </div>
    </div>
                                ...
                                <form method="get" action="">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4 d-flex align-items-end justify-content-end gap-2 flex-wrap">
                                            <a href="{{ route('kasbank.pembayaran.index') }}" class="btn btn-light">Reset</a>
    ...
    @include('partials.export-csv-modal', ['exportRoute' => route('kasbank.pembayaran.export-csv'), 'exportTitle' => 'Kasbank Pembayaran', 'startDate' => $startDate, 'endDate' => $endDate])
@endsection
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            window.jQuery('#datatable').DataTable({
                ...
                order: [[1, 'desc']],
                ajax: {
                    url: '{{ route('kasbank.pembayaran.load-data') }}',
                    type: 'GET',
                    data: function (d) {
