...
@section('content')
                                ...
                                <form method="get" action="">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4 d-flex align-items-end justify-content-end gap-2 flex-wrap">
                                            <a href="{{ route('bukubesar.jurnal-umum.index') }}" class="btn btn-light">Reset</a>
    ...
    @include('partials.export-csv-modal', ['exportRoute' => route('bukubesar.jurnal-umum.export-csv'), 'exportTitle' => 'Jurnal Umum', 'startDate' => $startDate, 'endDate' => $endDate])
@endsection
