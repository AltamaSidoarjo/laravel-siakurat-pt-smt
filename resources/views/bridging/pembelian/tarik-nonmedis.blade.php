...
@section('title', 'Tagihan Pembelian Barang Non Medis SIMRS')
    ...
    <div class="row mb-3">
        <div class="col">
            <div class="d-flex align-items-center gap-3 fs-3">
                ...
                <span class="fw-bold">Tagihan Pembelian Barang Non Medis SIMRS</span>
            </div>
        </div>
    </div>
            ...
            <div class="card border-muhammadiyah mb-2">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column gap-3">
                                ...
                                <form method="get" action="">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12 d-flex justify-content-end gap-2">
                                            <a href="{{ route('bridging.pembelian.tarik-nonmedis') }}" class="btn btn-light">Reset</a>
                        ...
                        <div class="card border-light shadow-sm">
                            <div class="card-body">
                                <form id="formImportNonMedis" method="post" action="{{ route('bridging.pembelian.process-import-nonmedis') }}">
                                    @csrf
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const table = window.jQuery('#datatable').DataTable({
                ...
                ajax: {
                    url: '{{ route('bridging.pembelian.load-tagihan-nonmedis') }}',
                    type: 'GET',
                    data: function (d) {
            ...
            document.getElementById('formImportNonMedis')?.addEventListener('submit', function (event) {
